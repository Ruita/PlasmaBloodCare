...
function validateForm() {
    ...
    var bloodType = document.getElementById("sel1");
    if (bloodType.options[bloodType.selectedIndex].value == 'selectBloodType') {
...
<li><a href="bloodStatus.php">BLOOD GROUP STATUS</a></li>
  ...
  <div class="well">
  <h2 style="text-align:center; color:#f4511e">Request Blood Form</h2><br>
  
    <form class="form-horizontal" role="form" name="myForm" onsubmit="return validateForm()">
    
      
      <div class="form-group">
      
        <label class="control-label col-sm-3" for="lastname" >Donor ID <span style="color:red">&nbsp;*</span></label>
        
        <div class="col-sm-5">
        
         <input type="text" class="form-control" id="donorId" placeholder=" Donor ID" required>
      ...
      <div class="form-group">
          <label class="control-label col-sm-3" for="Phone" required>Phone<span style="color:red">&nbsp;*</span></label>
           <div class="col-sm-5">
            <input type="text" class="form-control" id="title" placeholder="(000)-000-0000" pattern="^\d{3}-\d{3}-\d{4}$" required>
           </div>

      </div>
      <div class="form-group">
        <label class="control-label col-sm-3" for="organizationSize">Blood Type<span style="color:red">&nbsp;*</span></label>
         <div class="col-sm-5">
        <select class="form-control" id="sel1" required>
        <option value="selectBloodType">Select Blood Type</option>
        <option>A+</option>
        <option>A-</option>
        <option>B+</option>
        <option>B-</option>
