...
<div>
<h2 style='margin-top:7%;color:#f4511e;text-align:center'>BLOOD DRIVE HISTORY</h2>
</div>
...
echo "<label><b>View All</b> | <a href='view-paginated.php?page=1'>View Paginated</a></label>";



echo "<table  cellpadding='10' class='table table-striped' id='organizers'>";

echo "<tr> <th>ID</th> <th>First Name</th> <th>Last Name</th> <th>Phone</th> <th>Email</th> <th>Organization Name</th> <th>Address</th> <th>City</th> <th>Zip Code</th><th></th> <th></th></tr>";
...
<p style="margin-left:5%"><a href="new.php">Add a new record</a></p>
