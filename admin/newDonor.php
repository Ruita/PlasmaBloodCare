...
function renderForm($first, $last, $phone, $email,$address,$city,$zip, $error)
...
function myFunctionForNewBloodDrive()
{
...
<div class="well">
  <h2 style="text-align:center; color:#f4511e">Add New Donor!</h2><br>
...
renderForm($firstname, $lastname, $phoneNumber, $emailId , $address, $city, $zip, $error);
...
mysql_query("INSERT donor SET firstname='$firstname', lastname='$lastname', phone='$phoneNumber', email='$emailId', address='$address',city='$city', zip='$zip'")
