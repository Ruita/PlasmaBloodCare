...
function renderForm($id, $firstname, $lastname, $phone, $email,$address,$city,$zip, $error)
...
<li><a href="viewDonor.php">DONOR RECORD</a></li>
  ...
  <div class="well">
  <h2 style="text-align:center; color:#f4511e">Update Donor Record!</h2><br>
   ...
   <div class="form-group">
    ...
    <div class="form-group">
      <div class="col-sm-offset-3 col-sm-10">
        ...
        <a href="viewDonor.php" style="padding: 10px 19px; color:black"><font size="2">&#91;Cancel&#93;</font></a>
      </div>
    </div>
...
if ($firstname == '' || $lastname == ''|| $phoneNumber == '' || $emailId == '' || $address == '' || $city == '' || $zip == '')
...
renderForm($id, $firstname, $lastname, $phoneNumber, $emailId, $address, $city, $zip, $error);
...
mysql_query("UPDATE donor SET firstname='$firstname', lastname='$lastname', phone='$phoneNumber', email='$emailId', address='$address',city='$city', zip='$zip'  WHERE id='$id'")
...
$result = mysql_query("SELECT * FROM donor WHERE id=$id")
...
renderForm($id, $firstname, $lastname,$phoneNumber,$emailId, $address, $city, $zip, '');
